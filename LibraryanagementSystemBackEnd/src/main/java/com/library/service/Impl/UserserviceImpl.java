...
@Service //it is used to mark the class as a service provider, it is a specialization of @Component annotation, 
// it is used to indicate that the class provides some business functionalities
public class UserserviceImpl implements UserService {

    @Autowired // it is used to inject the dependency automatically, it is used to mark a constructor, field, setter method or config method as to be autowired by Spring's dependency injection facilities
